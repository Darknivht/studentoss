# 08-Flashcards — Flashcards

**Web reference:** `src/pages/Flashcards.tsx`

## Summary
SM-2 review queue, swipe left/right (don't know/got it), confetti on session complete. Uses useSubscription, react-native-deck-swiper, useAchievements.

...
**Web reference:** `src/pages/Safety.tsx`

## Summary
Parental controls (PIN), parent dashboard (read-only stats), content filter toggle, daily time limit slider. Under-14 flag enforces stricter defaults.

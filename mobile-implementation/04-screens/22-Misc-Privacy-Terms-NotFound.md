# 22-Misc-Privacy-Terms-NotFound — Misc

**Web reference:** `src/pages/Privacy.tsx,Terms.tsx,NotFound.tsx`

## Summary
Static screens. Render web markdown content via react-native-markdown-display. NotFound shown by navigator fallback.

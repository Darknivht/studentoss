...
**Web reference:** `src/pages/Store.tsx`

## Summary
Resource list filtered by grade_level, YouTubeSection, locked items show tier badge. Tap PDF -> open via react-native-pdf in modal.

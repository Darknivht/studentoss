...
User profile, avatar, education info, stats.
...
1. Create `src/screens/ProfileScreen.tsx` — copy every hook call from the web page verbatim.
2. Render a stub `<View><Text>Profile</Text></View>` and verify the route works in the navigator.

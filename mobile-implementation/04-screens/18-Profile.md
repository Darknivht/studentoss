...
**Web reference:** `src/pages/Profile.tsx`

## Summary
Avatar upload (expo-image-picker → supabase storage avatars bucket), edit name/school/grade/persona, sign out, link to Settings.

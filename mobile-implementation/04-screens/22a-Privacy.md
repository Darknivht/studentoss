...
> **RN target:** `src/screens/PrivacyScreen.tsx`  
> **Route name:** `Privacy`  
> **Nav type:** Stack  
> **Auth required:** No
...
1. Create `src/screens/PrivacyScreen.tsx` — copy every hook call from the web page verbatim.
2. Render a stub `<View><Text>Privacy</Text></View>` and verify the route works in the navigator.

...
**Web reference:** `src/pages/Career.tsx`

## Summary
Tabs: ResumeBuilder (templates → editor → preview → export PDF), JobSearch (job-search edge fn proxy), InternshipMatcher, RealWorldWhy. Resume templates gated by tier.

# 13-Chat-and-GroupChat — Chat

**Web reference:** `src/pages/Chat.tsx,src/pages/GroupChat.tsx`

## Summary
FlatList inverted, MediaUpload via expo-image-picker, replies (scrollIntoView equivalent: scrollToIndex), realtime via supabase channel on messages table.

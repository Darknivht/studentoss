...
**Web reference:** `src/pages/Upgrade.tsx`

## Summary
Pricing cards: Free / Plus / Pro with monthly/yearly toggle. Paystack via react-native-paystack-webview (Android/web). On iOS use RevenueCat IAP for App Store compliance. Calls verify-payment edge fn.

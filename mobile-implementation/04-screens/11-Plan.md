...
**Web reference:** `src/pages/Plan.tsx`

## Summary
Tabs: Timetable, Pomodoro, Sleep Calculator (Wake/SleepNow/Nap), Lofi Radio (expo-av, Pro tier ad-free), Goals, SmartScheduler, WeaknessDetector.

...
**Web reference:** `src/pages/Social.tsx`

## Summary
Tabs: Friends, Groups, Leaderboard, Challenges, PeerFinder. ChallengeAFriend creates peer_challenges row. Realtime subscriptions for live leaderboard.

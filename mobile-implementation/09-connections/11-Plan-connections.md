...
> Mobile spec: `mobile-implementation/04-screens/11-Plan.md`
...
| `@/components/planning/SmartScheduler` | **PORT** | Port to RN: timetable grid → ScrollView with absolute-positioned blocks. |
| `@/components/planning/WeaknessDetector` | **PORT** | Port to RN: timetable grid → ScrollView with absolute-positioned blocks. |
| `@/components/planning/StudyTimetable` | **PORT** | Port to RN: timetable grid → ScrollView with absolute-positioned blocks. |
| `@/components/planning/SleepCalculator` | **PORT** | Port to RN: timetable grid → ScrollView with absolute-positioned blocks. |
| `@/components/planning/LofiRadio` | **PORT** | Port to RN: timetable grid → ScrollView with absolute-positioned blocks. |
| `@/components/planning/ProgressTracker` | **PORT** | Port to RN: timetable grid → ScrollView with absolute-positioned blocks. |
| `@/components/study/PomodoroTimer` | **PORT** | Port to RN: course cards/grids → FlatList numColumns. |
| `@/components/study/StreakCalendar` | **PORT** | Port to RN: course cards/grids → FlatList numColumns. |
...
- `src/components/planning/SmartScheduler.tsx` ✅ exists in web → create `mobile/src/components/planning/SmartScheduler.tsx`
- `src/components/planning/WeaknessDetector.tsx` ✅ exists in web → create `mobile/src/components/planning/WeaknessDetector.tsx`
- `src/components/planning/StudyTimetable.tsx` ✅ exists in web → create `mobile/src/components/planning/StudyTimetable.tsx`
- `src/components/planning/SleepCalculator.tsx` ✅ exists in web → create `mobile/src/components/planning/SleepCalculator.tsx`
- `src/components/planning/LofiRadio.tsx` ✅ exists in web → create `mobile/src/components/planning/LofiRadio.tsx`
- `src/components/planning/ProgressTracker.tsx` ✅ exists in web → create `mobile/src/components/planning/ProgressTracker.tsx`
- `src/components/study/PomodoroTimer.tsx` ✅ exists in web → create `mobile/src/components/study/PomodoroTimer.tsx`
- `src/components/study/StreakCalendar.tsx` ✅ exists in web → create `mobile/src/components/study/StreakCalendar.tsx`
...
2. **Create the screen file** — `mobile/src/screens/PlanScreen.tsx`. Start from the matching `04-screens/11-Plan.md` layout tree.
...
11. **Wire to navigator** — register `PlanScreen` in the appropriate stack/tab in `mobile/src/navigation/`.

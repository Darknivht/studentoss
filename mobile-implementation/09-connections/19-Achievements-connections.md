...
> Mobile spec: `mobile-implementation/04-screens/19-Achievements.md`
...
- **DB tables**: `achievements`, `user_achievements`
...
| `canvas-confetti` | **KEEP** | Third-party package — install RN-compatible version if available. |
...
2. **Create the screen file** — `mobile/src/screens/AchievementsScreen.tsx`. Start from the matching `04-screens/19-Achievements.md` layout tree.
...
11. **Wire to navigator** — register `AchievementsScreen` in the appropriate stack/tab in `mobile/src/navigation/`.

...
> Web source: `src/pages/Flashcards.tsx`  
> Mobile spec: `mobile-implementation/04-screens/08-Flashcards.md`
...
| `@/components/flashcards/FlashcardsList` | **PORT** | Port to RN: use react-native-deck-swiper or Reanimated gesture handler for swipe. |
| `@/components/study/StudyStatistics` | **PORT** | Port to RN: course cards/grids → FlatList numColumns. |
...
- `src/components/flashcards/FlashcardsList.tsx` ✅ exists in web → create `mobile/src/components/flashcards/FlashcardsList.tsx`
- `src/components/study/StudyStatistics.tsx` ✅ exists in web → create `mobile/src/components/study/StudyStatistics.tsx`
...
2. **Create the screen file** — `mobile/src/screens/FlashcardsScreen.tsx`. Start from the matching `04-screens/08-Flashcards.md` layout tree.
...
11. **Wire to navigator** — register `FlashcardsScreen` in the appropriate stack/tab in `mobile/src/navigation/`.

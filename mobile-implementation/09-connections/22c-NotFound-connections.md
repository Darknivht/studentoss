# Connections — `NotFound`

> Web source: `src/pages/NotFound.tsx`  
> Mobile spec: `mobile-implementation/04-screens/22c-NotFound.md`
...
2. **Create the screen file** — `mobile/src/screens/NotFoundScreen.tsx`. Start from the matching `04-screens/22c-NotFound.md` layout tree.
...
11. **Wire to navigator** — register `NotFoundScreen` in the appropriate stack/tab in `mobile/src/navigation/`.

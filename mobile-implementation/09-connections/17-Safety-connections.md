...
> Mobile spec: `mobile-implementation/04-screens/17-Safety.md`
...
| `@/components/safety/ParentalControls` | **PORT+NATIVE** | ParentalControls UI ports easily; FocusLock needs Android native module (see 06-native-features/01). |
| `@/components/safety/ParentDashboard` | **PORT+NATIVE** | ParentalControls UI ports easily; FocusLock needs Android native module (see 06-native-features/01). |
| `@/components/settings/AppBlockerSettings` | **PORT** | Port to RN: settings list → SectionList. AppBlockerSettings needs native module. |
...
- `src/components/safety/ParentalControls.tsx` ✅ exists in web → create `mobile/src/components/safety/ParentalControls.tsx`
- `src/components/safety/ParentDashboard.tsx` ✅ exists in web → create `mobile/src/components/safety/ParentDashboard.tsx`
- `src/components/settings/AppBlockerSettings.tsx` ✅ exists in web → create `mobile/src/components/settings/AppBlockerSettings.tsx`
...
2. **Create the screen file** — `mobile/src/screens/SafetyScreen.tsx`. Start from the matching `04-screens/17-Safety.md` layout tree.
...
11. **Wire to navigator** — register `SafetyScreen` in the appropriate stack/tab in `mobile/src/navigation/`.

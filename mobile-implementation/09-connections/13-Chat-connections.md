...
> Web source: `src/pages/Chat.tsx`  
> Mobile spec: `mobile-implementation/04-screens/13-Chat.md`
...
- **DB tables**: `profiles`, `study_groups`
...
2. **Create the screen file** — `mobile/src/screens/ChatScreen.tsx`. Start from the matching `04-screens/13-Chat.md` layout tree.
...
11. **Wire to navigator** — register `ChatScreen` in the appropriate stack/tab in `mobile/src/navigation/`.

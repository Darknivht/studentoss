...
> Mobile spec: `mobile-implementation/04-screens/02b-Index.md`
...
2. **Create the screen file** — `mobile/src/screens/IndexScreen.tsx`. Start from the matching `04-screens/02b-Index.md` layout tree.
...
11. **Wire to navigator** — register `IndexScreen` in the appropriate stack/tab in `mobile/src/navigation/`.

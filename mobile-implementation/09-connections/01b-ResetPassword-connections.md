# Connections — `ResetPassword`

> Web source: `src/pages/ResetPassword.tsx`  
> Mobile spec: `mobile-implementation/04-screens/01b-ResetPassword.md`
...
2. **Create the screen file** — `mobile/src/screens/ResetPasswordScreen.tsx`. Start from the matching `04-screens/01b-ResetPassword.md` layout tree.
...
11. **Wire to navigator** — register `ResetPasswordScreen` in the appropriate stack/tab in `mobile/src/navigation/`.

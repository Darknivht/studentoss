...
> Mobile spec: `mobile-implementation/04-screens/01-Auth.md`
...
| `zod` | **KEEP** | Third-party package — install RN-compatible version if available. |
...
2. **Create the screen file** — `mobile/src/screens/AuthScreen.tsx`. Start from the matching `04-screens/01-Auth.md` layout tree.
...
11. **Wire to navigator** — register `AuthScreen` in the appropriate stack/tab in `mobile/src/navigation/`.

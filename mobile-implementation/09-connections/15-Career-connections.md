...
> Web source: `src/pages/Career.tsx`  
> Mobile spec: `mobile-implementation/04-screens/15-Career.md`
...
| `@/components/career/RealWorldWhy` | **PORT** | Port to RN: ResumeBuilder uses InputRow primitive (see memory). Job search calls existing edge function. |
| `@/components/career/ResumeBuilder` | **PORT** | Port to RN: ResumeBuilder uses InputRow primitive (see memory). Job search calls existing edge function. |
| `@/components/career/InternshipMatcher` | **PORT** | Port to RN: ResumeBuilder uses InputRow primitive (see memory). Job search calls existing edge function. |
...
- `src/components/career/RealWorldWhy.tsx` ✅ exists in web → create `mobile/src/components/career/RealWorldWhy.tsx`
- `src/components/career/ResumeBuilder.tsx` ✅ exists in web → create `mobile/src/components/career/ResumeBuilder.tsx`
- `src/components/career/InternshipMatcher.tsx` ✅ exists in web → create `mobile/src/components/career/InternshipMatcher.tsx`
...
2. **Create the screen file** — `mobile/src/screens/CareerScreen.tsx`. Start from the matching `04-screens/15-Career.md` layout tree.
...
11. **Wire to navigator** — register `CareerScreen` in the appropriate stack/tab in `mobile/src/navigation/`.

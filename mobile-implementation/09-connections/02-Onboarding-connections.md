...
> Mobile spec: `mobile-implementation/04-screens/02-Onboarding.md`
...
2. **Create the screen file** — `mobile/src/screens/OnboardingScreen.tsx`. Start from the matching `04-screens/02-Onboarding.md` layout tree.
...
11. **Wire to navigator** — register `OnboardingScreen` in the appropriate stack/tab in `mobile/src/navigation/`.

...
> Web source: `src/pages/AITutor.tsx`  
> Mobile spec: `mobile-implementation/04-screens/07-AITutor.md`
...
2. **Create the screen file** — `mobile/src/screens/AITutorScreen.tsx`. Start from the matching `04-screens/07-AITutor.md` layout tree.
...
11. **Wire to navigator** — register `AITutorScreen` in the appropriate stack/tab in `mobile/src/navigation/`.

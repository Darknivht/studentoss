...
> Mobile spec: `mobile-implementation/04-screens/22b-Terms.md`
...
2. **Create the screen file** — `mobile/src/screens/TermsScreen.tsx`. Start from the matching `04-screens/22b-Terms.md` layout tree.
...
11. **Wire to navigator** — register `TermsScreen` in the appropriate stack/tab in `mobile/src/navigation/`.

...
> Mobile spec: `mobile-implementation/04-screens/16-Focus.md`
...
- **DB tables**: `courses`, `pomodoro_sessions`
...
2. **Create the screen file** — `mobile/src/screens/FocusScreen.tsx`. Start from the matching `04-screens/16-Focus.md` layout tree.
...
11. **Wire to navigator** — register `FocusScreen` in the appropriate stack/tab in `mobile/src/navigation/`.

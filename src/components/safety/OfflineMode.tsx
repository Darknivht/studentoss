          ...
          <div className="space-y-4">
            ...
            {offlineAI.isDownloading && (
              <div className="p-4 bg-muted/50 rounded-xl space-y-3">
                ...
                {offlineAI.supportsBackgroundDownload && (
                  <div className="flex items-center gap-2 text-xs text-green-600 dark:text-green-400 bg-green-500/10 px-3 py-2 rounded-lg">
                    <Smartphone className="w-3 h-3" />
                    <span>Download continues in background - check notifications!</span>
                  </div>
                )}

      ...
      const dailyChallenges: Challenge[] = [
        {
          ...
          target: 2,
          current: notesRes.count || 0,
          xpReward: 50,
          type: 'notes',
          completed: (notesRes.count || 0) >= 2,
        },
        {
          id: 'quiz_daily',
          title: 'Quiz Master',
          ...
          target: 1,
          current: quizzesRes.count || 0,
          xpReward: 30,
          type: 'quizzes',
          completed: (quizzesRes.count || 0) >= 1,
        },
        {
          id: 'flashcards_daily',
          title: 'Card Shark',
          ...
          target: 10,
          current: Math.min(flashcardsRes.count || 0, 10),
          xpReward: 40,
          type: 'flashcards',
          completed: (flashcardsRes.count || 0) >= 10,
        },
        {
          id: 'focus_daily',
          title: 'Deep Focus',
      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-lg font-bold">
                {levelInfo.level < 5 ? 'Beginner' : levelInfo.level < 10 ? 'Apprentice' : levelInfo.level < 15 ? 'Scholar' : 'Master'}
              </p>
            </div>
          </div>
        ...
        <div className="space-y-1">
          <div className="flex justify-between text-xs opacity-80">
            ...
            <span>{totalXp - levelInfo.currentLevelXp} / {levelInfo.nextLevelXp - levelInfo.currentLevelXp} XP</span>
          </div>
          ...
          >
            <div className="flex items-center gap-3">
              <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${
                challenge.completed ? 'bg-emerald-500/20' : 'bg-primary/10'
              }`}>
                {challenge.completed ? (

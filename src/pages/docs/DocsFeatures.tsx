    ...
    <section>
      ...
      <div className="grid gap-3 text-sm">
        {[
          ...
          { name: 'Exam Prep (CBT)', desc: 'Computer-Based Test practice. Multiple exam types (WAEC, JAMB, etc). Subject/topic selection. Timer. Session persistence (auto-save/resume). Mock exam mode.' },
          ...
          { name: 'Career Tools', desc: 'Resume builder, job/internship search, real-world-why explainer.' },

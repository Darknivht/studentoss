  ...
  return (
    <SafeAreaView className="flex-1 bg-background">
      <ScrollView contentContainerClassName="p-6">
        <Text className="font-display text-3xl text-foreground mb-2">Onboarding</Text>
        ...
        <View className="rounded-2xl bg-card p-4 border border-border">
          <Text className="text-card-foreground">
            Connections spec: mobile-implementation/09-connections/*-Onboarding-connections.md
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
